...
And(`user completes and submit job application correctly`, function () {
...
Then(`user application should be successful with text displayed {string}`, function (successMsg) {
    applicationForm.verifySubmission(successMsg);
})